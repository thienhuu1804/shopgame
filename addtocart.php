...
if (!empty($_SESSION["cart"]))
{
	...
	$s=$s.'<tr id="'.$key.'">
		<td><img width="150px" height="100px" src="'.$_SESSION["cart"][$key]["hinhanh"].'"></td>
		...
		<td><input type="button" class="Giam" name="amountDecrease" value="-" "/>
			...
			<td><button style="margin-bottom: 10px" type="button" class="btn btn-danger btn-lg btn-sm"><span class="glyphicon glyphicon-trash"></span></button></td>
		</tr>';
	}
}
